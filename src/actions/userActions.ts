...
export const getUserDetails = ( id: string )=> async (dispatch: Dispatch, getState: RootState)=>{
    ...
    try {
        ...
        const {userInfo: { userInfo}} = getState.users.login
...
export const  deleteUser = ( id: number )=> async (dispatch: Dispatch, getState: RootState)=>{
...
export const  updateUser = ( user: any )=> async (dispatch: Dispatch, getState: RootState)=>{
